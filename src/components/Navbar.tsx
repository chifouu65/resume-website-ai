    ...
    <>
      {
        links.map((link) => {
          return (
            <button onClick={link.event} key={link.id} className="mr-4 flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-gray-500 dark:focus:ring-offset-gray-800 dark:focus:ring-white" aria-label={link.name}>
...
const Navbar = () => {
  ...
  const links = [
    {
      id: 'toggleFeatureMenu',
      name: 'Feature',
      icon: <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 011 1v10a1 1 0 01-1 1H4a1 1 0 01-1-1V5zm1 0v10h12V5H4z" clip-rule="evenodd"></path></svg>,
    ...
    },
    {
      id: 'toggleUserMenu',
      name: 'User',
      icon: <><img className="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user"/></>,
      url: 'https://flowbite.com',
      current: true,
      event: handleUserMenu
    },
  ]
          ...
          <div className="flex flex-wrap justify-between items-center">
              ...
              <div className="flex justify-start items-center">
                <a href="https://flowbite.com" className="flex mr-4">
                  ...
                  <span className="hidden md:block self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
                </a>
              </div>
              { /* Links */ }
